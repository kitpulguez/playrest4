# Imagen base
FROM node:18
# Crea un directorio llamado "app" en la ruta /usr/src/ con la opción -p para asegurar que
# se crean todos los subdirectorios, incluso si ya existen.
...
# host donde se está construyendo el contenedor Docker al directorio de trabajo actual en
# el contenedor
COPY . .
